...
const paymentPlans = [
  { id: 'free', name: 'FREE', price: '$0 / month', description: 'Perfect for Casual free Postings.' },
  { id: 'pro', name: 'PRO', price: '$50 / month', description: 'For Regular Postings! 100+ posting with VIP Tab !' },
  { id: 'team', name: 'TEAM', price: '$100 / month', description: ' For Agency Escorts 1000+ Postings with team !' },
];
...
export default function CreateListing() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <form onSubmit={handleSubmit} className="space-y-8 bg-gray-900 bg-opacity-75 p-8 rounded-lg shadow-lg">
        {/* Basic Information */}
