  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex space-x-2">
                          <span className={`px-3 py-1 rounded-full text-sm font-medium ${getStatusBadgeClass(listing.status)}`}>
                            {listing.status.charAt(0).toUpperCase() + listing.status.slice(1)}
                          </span>
                          <span className={`px-3 py-1 rounded-full text-sm font-medium ${getPlanBadgeClass(listing.payment_plan)}`}>
                      ...
                      <div className="mt-2 text-sm text-gray-500">
                        ...
                        <div className="grid grid-cols-2 gap-4 mt-4">
                          <div>
                            ...
                            <p><span className="font-medium">Price:</span> AED {listing.price}</p>
                            <p><span className="font-medium">Created:</span> {formatDate(listing.created_at)}</p>
                          </div>
                          <div>
                            <p><span className="font-medium">Phone:</span> {listing.phone || 'N/A'}</p>
                            <p><span className="font-medium">Email:</span> {listing.email || 'N/A'}</p>
                          </div>
                        </div>
                      </div>
                    </div>
      ...
      {view === 'blogs' && (
        <div className="bg-white shadow overflow-hidden sm:rounded-lg">
          <div className="p-6">
            <Link href="/admin/blog-posts" className="block bg-[#00000091] text-white  px-4 py-2 rounded mb-4">
              Manage Blog Posts
            </Link>
          </div>
        </div>
