...
export default function ListingDetails() {
  ...
  const handlePrevImage = () => {
    if (listing) {
      setMainImageIndex((prevIndex) => (prevIndex - 1 + listing.additional_images.length + 1) % (listing.additional_images.length + 1));
    }
  };
          ...
          <ol className="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li>
              <div className="flex items-center">
                ...
                <Link to="/" className="ml-1 text-sm font-medium text-white hover:text-gray-900 md:ml-2">
                  Listings
                </Link>
              </div>
            </li>
        ...
        <div className="flex flex-col lg:flex-row bg-[#000000c7] shadow-lg rounded-lg p-6">
          ...
          <div className="flex-1 space-y-4">
            ...
            <div>
              ...
              {listing.website && (
                <a href={listing.website} target="_blank" rel="noopener noreferrer" className="text-white hover:underline">
                  {listing.website}
                </a>
              )}
            </div>
