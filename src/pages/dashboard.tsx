          ...
          {filteredListings.map((listing) => (
            <li key={listing.id}>
              <div className="px-4 py-4 sm:px-6 flex items-center">
                <img src={listing.profile_image} alt="Profile" className="h-40 w-40 rounded-md object-cover mr-4" />
                <div className="flex-grow cursor-pointer" onClick={() => handleView(listing.id)}>
                  <div className="flex items-center justify-between">
                    <div className="flex-1 min-w-0">
                      <h3 className="text-white text-2xl font-white font-medium text-gray-900 truncate">
                        {listing.title}
                      </h3>
                  ...
                  <div className="mt-2 sm:flex sm:justify-between">
                    ...
                    <div className="mt-2 flex items-center text-sm text-gray-500 sm:mt-0">
                      ...
                      <span className={`ml-2 text-sm font-medium ${listing.status === 'approved' ? 'text-green-600' : listing.status === 'pending' ? 'text-yellow-600' : 'text-red-600'}`}>
                        {listing.status}
                      </span>
                    </div>
                  </div>
