  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content={`https://lightpink-buffalo-448231.hostingersite.com/listings/${listing.id}`} />
        <link rel="canonical" href={`https://lightpink-buffalo-448231.hostingersite.com/listings/${listing.id}`} />
      </Head>
              ...
              <div className="space-y-4">
                ...
                <section className="flex flex-col space-y-2">
                  ...
                  <span className="text-sm text-gray-300">
                    Tell that you're calling from Delhi-escorts.com to increase your chances of getting a discount.
                  </span>
                </section>
...
export const getStaticPaths: GetStaticPaths = async () => {
  // Fetch all listing IDs to pre-render
